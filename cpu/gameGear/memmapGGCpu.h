...
#include "../../apu/gameGear/memmapGGApu.h"
#include "../../vdp/gameGear/memmapGGVdp.h"
#include "../../io/gameGear/inputMapperGG.h"
#include "../../config.h"
#include<memory>

class memmapGGCpu: public memmapZ80 {
public:
    memmapGGCpu(std::shared_ptr<config> cfg);
...
private:
    ...
    std::shared_ptr<memmapGGApu>   apu;
    std::shared_ptr<memmapGGVdp>   vdp;
